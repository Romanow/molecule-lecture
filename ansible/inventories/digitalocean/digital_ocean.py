...
class DigitalOceanInventory(object):
    ...
    def load_from_digital_ocean(self, resource=None):
        ...
        if self.is_cache_valid() and not (
            resource == "droplets" or resource is None):
            return
